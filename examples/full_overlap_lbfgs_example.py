"""
Full-Overlap L-BFGS Implementation

Demonstrates how to implement a simple full-overlap L-BFGS with a probabilistic 
Armijo backtracking line search to train a simple convolutional neural network 
using the LBFGS optimizer. Full-overlap L-BFGS is a stochastic quasi-Newton method 
that uses the same sample as the one used in the stochastic gradient to perform 
quasi-Newton updating, then resamples an entirely independent new sample in the 
next iteration.
